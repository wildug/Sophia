...
\begin{frame}{Lion SophiaG does not outperform AdamW on adapted NanoGPT} % The optional argument 'plain' hides the headline and footline
	\begin{center}
		\begin{itemize}
			\item SophiaG has approximately the same loss as AdamW
			\item in my setup the computational overhead cleary outweighs the benefits of additionally gained curvature information
			\item a simple to add Lion implementation slightly outperforms AdamW \& SophiaG in this specific setup
		\end{itemize}
	\end{center}
\end{frame}
\begin{frame}[plain] % The optional argument 'plain' hides the headline and footline
