...
\]
		...
		\begin{column}{0.55\textwidth} % Right column width
        	\begin{figure}
        	    \centering
                % \includegraphics[width=6.5cm]{figures/longitudinal_relaxation.png}
        	    % \caption*{Longitdunial Relaxation; time in s}
                % \includegraphics[width=6.5cm]{figures/transversal_relaxation.png}
        	    % \caption*{Transverse Relaxation; time in ms}
        	\end{figure}
		\end{column}
	\end{columns}
\end{frame}
 ...
 \begin{frame}
	...
	\begin{itemize}
		...
		$\Longrightarrow$ results in contrast for different tissues
        	\begin{figure}
        	    \centering
                % \includegraphics[width=11.5cm]{figures/T1_T2.png}
        	    % \caption*{visualization of $T_1$ and $T_2$ contrast}
        	\end{figure}
	\end{itemize}
\end{frame}
...
\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		...
		\begin{column}{0.55\textwidth} % Right column width
        	\begin{figure}
        	    \centering
                % \includegraphics[width=5.5cm]{figures/k-space.png}
        	\end{figure}
		\end{column}
	\end{columns}
\end{frame}
